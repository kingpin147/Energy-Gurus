    ...
    return (
        <form action={addPodcast} className="space-y-4">
            <div className="space-y-2">
                ...
                <input name="title" className="w-full border rounded-xl p-3 bg-secondary/5 focus:ring-2 focus:ring-primary outline-none" required />
            </div>
            <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest opacity-60">YouTube URL</label>
                <input name="youtubeUrl" placeholder="https://youtube.com/watch?v=..." className="w-full border rounded-xl p-3 bg-secondary/5 focus:ring-2 focus:ring-primary outline-none" required />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
                ...
                <input name="guestName" className="w-full border rounded-xl p-3 bg-secondary/5 focus:ring-2 focus:ring-primary outline-none" />
            </div>
            <div className="space-y-2">
            ...
            >
                {isUploading ? "Uploading..." : <><Plus className="w-4 h-4" /> Add Episode</>}
            </Button>
        </form>
    );
}
