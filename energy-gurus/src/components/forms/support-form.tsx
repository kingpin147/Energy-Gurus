...
export function SupportForm() {
    ...
    if (status === 'success') {
        return (
            <div className="text-center py-16 space-y-4 max-w-lg mx-auto bg-card border rounded-3xl p-8">
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl bg-card border rounded-3xl p-6 sm:p-8">
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    className="w-full min-h-[160px] p-4 rounded-2xl border bg-secondary/5 focus:ring-2 focus:ring-primary outline-none transition-all resize-none text-sm"
                    required
                />
            </div>
