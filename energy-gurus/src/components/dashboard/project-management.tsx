        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold flex items-center gap-2">
                    <LayoutGrid className="w-6 h-6 text-amber" /> Showcase Projects
                </h3>
                <Button
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-2 bg-paper border rounded-2xl p-3">
                                                    ...
                                                    return (
                                                        <label
                                                            ...
                                                            className={`flex items-center gap-2.5 p-2 rounded-xl text-xs font-bold cursor-pointer transition-all border ${
                                                                isChecked
                                                                ? "bg-amber/5 text-ink border-amber/20 text-amber"
                                                                : "bg-transparent border-transparent text-slate-custom hover:bg-paper/5"
                                                            }`}
                                                        >
                                                            <input
                                                                type="checkbox"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input name="systemSize" defaultValue={editingProject?.systemSize || ""} placeholder="10" className="w-full border rounded-2xl p-4 bg-paper outline-none" />
                                        </div>
                                        <div>
                                            <label className="text-[10px] font-black uppercase tracking-widest mb-2 block">System Type</label>
                                            <select name="systemType" defaultValue={editingProject?.systemType || "Hybrid"} className="w-full border rounded-2xl p-4 bg-paper outline-none">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            <input name="inverterModel" defaultValue={editingProject?.inverterModel || ""} placeholder="Inverter Brand/Model" className="w-full border rounded-xl p-3 bg-paper outline-none text-sm" />
                                            <input name="solarPanelModel" defaultValue={editingProject?.solarPanelModel || ""} placeholder="Solar Panel Brand/Model" className="w-full border rounded-xl p-3 bg-paper outline-none text-sm" />
                                            <input name="batteryModel" defaultValue={editingProject?.batteryModel || ""} placeholder="Battery Brand/Model" className="w-full border rounded-xl p-3 bg-paper outline-none text-sm" />
                                        </div>
                                    </div>
                                    <div className="pt-2">
                            ...
                            <div className="pt-6 border-t border-amber/10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div className="border-2 border-dashed border-amber/20 rounded-[2rem] p-8 text-center bg-white/50 relative overflow-hidden">
                                            {isUploading ? (
                                                <div className="flex flex-col items-center gap-4 py-4">
                                                    <Loader2 className="w-10 h-10 text-amber animate-spin" />
                                                    <p className="text-xs font-bold uppercase tracking-widest text-amber">Uploading Content...</p>
                                                </div>
                                            ) : (
                                                <>
                                                    <ImageIcon className="w-8 h-8 text-amber/30 mx-auto mb-3" />
                                                    <input
                                                        type="file"
                                                        ref={fileInputRef}
                                                        className="hidden"
                                                    ...
                                                    <button
                                                        ...
                                                        className="bg-amber text-ink text-white font-bold rounded-xl px-6 h-12 text-sm flex items-center justify-center gap-2 mx-auto hover:scale-[1.02] transition-all shadow-lg shadow-primary/20"
                                                    >
                                                        <Upload className="w-4 h-4" />
                                                        Select Photos & Videos
                                                    </button>
                                                    <p className="text-[10px] font-bold text-slate-custom mt-4 uppercase tracking-widest">Images (Max 10) & Videos (Max 2)</p>
                                                </>
                                            )}
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-4 gap-3">
                                                ...
                                                {uploadedVideos.map((vid, i) => (
                                                    <div key={i} className="aspect-square rounded-xl overflow-hidden border group relative bg-paper/10 flex items-center justify-center shadow-sm">
                                                        <VideoIcon className="w-6 h-6 text-amber/40" />
                                                        <button
                                                            type="button"
                                    ...
                                    <div className="bg-amber/5 text-ink rounded-[2.5rem] p-8 space-y-4 border border-amber/10">
                                        <h4 className="text-[10px] font-black uppercase tracking-widest opacity-40">Quick Guidelines</h4>
                                        <ul className="text-xs space-y-3 font-medium text-slate-custom">
                                            <li className="flex items-start gap-2">
                                                <div className="w-1.5 h-1.5 bg-amber text-ink rounded-full mt-1.5 shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.map((project: Project) => (
                    <Card key={project.id} className="border-none shadow-sm rounded-[2rem] overflow-hidden group hover:shadow-xl transition-all duration-500 bg-white">
                        <div className="aspect-video relative overflow-hidden bg-paper/10">
                            ...
                            <div className="absolute top-4 left-4 flex flex-wrap gap-2 max-w-[80%]">
                                {(() => {
                                    ...
                                    return segments.map(seg => (
                                        <span key={seg} className="bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-amber shadow-sm border border-amber/10">
                                            {seg}
                                        </span>
                                    ));
                                })()}
                                {project.videos && project.videos.length > 0 && (
                                    <span className="bg-paper/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-white shadow-sm">
                        ...
                        <CardContent className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-slate-custom flex items-center gap-1 font-medium">
                            ...
                            <div className="pt-4 border-t border-paper/10 flex justify-between items-center">
                                <div className="text-[10px] text-slate-custom uppercase tracking-widest font-black opacity-60">
                                    {project.systemType}
                                </div>
                                <div className="text-[10px] font-black text-amber uppercase tracking-widest">
                                    Manage Content
                                </div>
                            </div>
                        </CardContent>
                ...
                {projects.length === 0 && !isFormOpen && (
                    <div className="col-span-full py-20 text-center bg-paper/5 rounded-[3rem] border-2 border-dashed border-paper/20">
                        <LayoutGrid className="w-12 h-12 text-slate-custom/20 mx-auto mb-4" />
                        <h4 className="font-bold text-lg">No Projects Showcased</h4>
                        <p className="text-slate-custom text-sm max-w-xs mx-auto mt-2">
