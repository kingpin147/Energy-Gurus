...
export function DatasheetUpload() {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 border-2 border-dashed rounded-2xl bg-paper/5 border-paper/20">
                {!url ? (
                    <div className="w-full">
                        ...
                        <button
                            ...
                            className="w-full bg-amber text-ink text-white font-bold rounded-xl px-6 h-10 text-xs flex items-center justify-center gap-2 hover:scale-[1.01] transition-all disabled:opacity-50"
                        >
                            {isUploading ? (
