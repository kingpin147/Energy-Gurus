...
interface BrandContactButtonsProps {
    brandId: string;
    brandName: string;
    userId: string;
    website?: string | null;
...
export function BrandContactButtons({ brandId, brandName, userId, website, whatsappNumber }: BrandContactButtonsProps) {
    return (
        <div className="space-y-4">
            <Dialog>
                ...
                <DialogContent className="sm:max-w-[500px] rounded-[3rem] p-0 overflow-hidden border-none text-foreground">
                    ...
                    <div className="p-10 bg-white">
                        <ContactForm receiverId={userId} receiverName={brandName} />
                    </div>
                </DialogContent>
            </Dialog>
            ...
            {website ? (
                <TrackedLink
                    ...
                    eventProperties={{ brandId, brandName, url: website }}
                >
