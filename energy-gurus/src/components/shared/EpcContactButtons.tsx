    ...
    return (
        <div className="space-y-4">
            ...
            <Dialog>
                ...
                <DialogContent className="sm:max-w-xl rounded-[2.5rem] border-none p-0 overflow-hidden text-foreground">
                    <div className="bg-primary p-8 text-white">
                        <DialogHeader>
                            <DialogTitle className="text-2xl font-black">Direct Message</DialogTitle>
                            <p className="text-white/60 text-sm font-medium">Send a secure inquiry to {companyName}</p>
                        </DialogHeader>
                    </div>
