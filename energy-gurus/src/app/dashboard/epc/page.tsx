            ...
            <Card className="border-none shadow-sm rounded-3xl">
              ...
              <CardContent>
                <EpcProfileForm
                  ...
                  defaultDesignation={epc.designation || ""}
                  defaultBusinessType={epc.businessType || ""}
                  defaultContactNo={epc.contactNo || ""}
                  defaultWhatsapp={epc.whatsapp || ""}
                  defaultAddress={epc.address || ""}
                  defaultArea={epc.area || ""}
                  defaultCity={epc.city || ""}
                  defaultCountry={epc.country || "Pakistan"}
                  ...
                  defaultPhotos={(epc as any).photos || []}
                  defaultSolarCertDocuments={(epc as any).solarCertDocuments || []}
                  defaultInverterCertDocuments={(epc as any).inverterCertDocuments || []}
                  defaultBatteryCertDocuments={(epc as any).batteryCertDocuments || []}
