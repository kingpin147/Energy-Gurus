    ...
    return (
        <div className="max-w-lg w-full bg-white rounded-[2.5rem] shadow-2xl p-10 md:p-14 text-center space-y-8 relative z-10 border border-line/50">
            ...
            <div className="space-y-4">
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-graphite">{title}</h1>
            ...
            <div className="p-6 bg-paper/10 rounded-2xl border border-paper/20 space-y-3">
                <div className="flex items-center justify-center gap-2 text-sm font-bold text-graphite">
                    <MailWarning className="w-4 h-4 text-amber" />
                ...
                <p className="text-sm text-slate-custom leading-relaxed">
                    ...
                    <a href="mailto:energygurusonline@gmail.com" className="block font-bold text-amber mt-1 hover:underline">energygurusonline@gmail.com</a>
                </p>
            </div>

            <div className="pt-4 flex flex-col sm:flex-row gap-4">
                <Button className="flex-1 h-14 rounded-xl font-bold text-base bg-amber text-ink hover:bg-amber/90" asChild>
...
export default function RejectAccessPage() {
    return (
        <div className="min-h-screen bg-paper flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-amber/5 text-ink rounded-full blur-3xl pointer-events-none" />

            <Suspense fallback={<div className="max-w-lg w-full bg-white rounded-[2.5rem] shadow-2xl p-10 md:p-14 text-center space-y-8 relative z-10 border border-line/50">Loading...</div>}>
                <RejectAccessContent />
            </Suspense>
        </div>
    );
