...
function renderStars(rating: number) {
  const full = Math.floor(Math.min(5, rating));
  ...
  return (
    <div className="font-sans text-graphite bg-paper leading-relaxed selection:bg-amber/20 min-h-screen">
      ...
      <div className="max-w-[1180px] mx-auto px-5 md:px-8 mt-7">
        <AdBanner placement="leaderboard_top" targetPage="epcs" />
      </div>
      ...
      <InstallerFilters totalCount={installers.length}>
        ...
        {installers.length === 0 && (
          <div className="py-20 text-center bg-white border border-line rounded-[4px]">
            ...
            <p className="text-slate-custom text-[0.95rem]">Try adjusting your search query or filters.</p>
          </div>
        )}
