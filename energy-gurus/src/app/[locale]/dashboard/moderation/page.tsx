        ...
        <div className="p-8 space-y-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Monitor and moderate reviews for EPCs and Brands.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between gap-6">
                                <div className="flex-1 space-y-4">
                                    ...
                                    <div className="bg-secondary/5 p-4 rounded-xl border italic text-muted-foreground">
                                        "{review.comment}"
                                    </div>
                ...
                {allReviews.length === 0 && (
                    <div className="py-20 text-center border-2 border-dashed rounded-[3rem] bg-secondary/5">
                        <MessageSquare className="w-12 h-12 text-muted-foreground/20 mx-auto mb-4" />
                        <h3 className="text-xl font-bold">No reviews yet</h3>
                        <p className="text-muted-foreground">User feedback will appear here for moderation.</p>
                    </div>
                )}
            </div>
        </div>
