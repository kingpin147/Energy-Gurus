...
import { Building2, Briefcase, MousePointerClick, Globe, Facebook, Twitter, Linkedin, Instagram, MessageSquare } from "lucide-react";
        ...
        <CardHeader className="p-8 border-b border-border/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-medium">Top 20 brands ranked by total user engagement</p>
            </div>
          </div>
        </CardHeader>
