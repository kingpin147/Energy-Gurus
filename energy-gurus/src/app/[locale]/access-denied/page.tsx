...
export default function AccessDeniedPage() {
    return (
        <div className="min-h-screen bg-secondary/5 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl p-12 text-center space-y-8 border-t-8 border-primary">
                ...
                <div className="p-6 bg-secondary/5 rounded-2xl border border-secondary/10 space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground text-left leading-relaxed">
                        ...
                        <span className="block font-bold text-foreground mt-1">energygurusonline@gmail.com</span>
                    </p>
                </div>
