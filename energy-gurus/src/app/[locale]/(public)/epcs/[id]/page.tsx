                ...
                {projects.map((project) => (
                  <div key={project.id} className="group relative rounded-[3rem] overflow-hidden bg-white border border-border/50 premium-shadow transition-all duration-500 hover:-translate-y-2">
                    <div className="aspect-[4/3] relative overflow-hidden">
                      {project.images?.[0] ? (
                        <img src={project.images[0]} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" alt={project.name} />
                      ) : (
                  ...
                  <div className="space-y-4">
                    {(() => {
                      ...
                      if (whatsapp) {
                        ...
                        return (
                          <Button className="w-full h-16 rounded-[1.5rem] font-black text-lg bg-[#25D366] hover:bg-[#20bd5a] text-white gap-3 shadow-lg shadow-[#25D366]/20 transition-all hover:scale-[1.02]" asChild>
