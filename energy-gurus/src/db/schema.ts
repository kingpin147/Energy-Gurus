...
export const brands = pgTable('brands', {
  ...
  distributors: jsonb('distributors').$type<{ name: string; city: string; territory: string; contactPerson: string; phone: string; email: string; address: string }[]>().default([]),
  retailers: jsonb('retailers').$type<{ name: string; city: string; address: string; phone: string; whatsapp: string; mapUrl: string }[]>().default([]),
  serviceCentres: jsonb('service_centres').$type<{ name: string; type: string; city: string; address: string; phone: string; hotline: string; hours: string; services: string[] }[]>().default([]),
  certifiedInstallers: jsonb('certified_installers').$type<{ installerName: string; installerId?: string; tier: string; city: string }[]>().default([]),
  socialLinks: jsonb('social_links').$type<{ platform: string; url: string }[]>().default([]),
  isVerified: boolean('is_verified').default(false),
  createdAt: timestamp('created_at').defaultNow().notNull(),
  updatedAt: timestamp('updated_at').defaultNow().notNull()
